                ...
                switch (TagType)
                    {
                        ...
                        case NbtTagType.IntArray:
                            ...
                            for (int i = 0; i < TagLength; i++) ints[i] = reader.ReadInt32();
                ...
                switch (TagType)
                    {
                        ...
                        case NbtTagType.IntArray:
                            ...
                            for (int i = 0; i < TagLength; i++) intValue[i] = reader.ReadInt32();
                            value = intValue;
                            break;
                ...
                switch (ListType)
                    {
                        ...
                        default:
                            throw new InvalidOperationException(
                                "ReadListAsArray may only be used on lists of value types.");
                    }
        ...
        public string ToString(bool includeValue, [NotNull] string indentString)
            {
                ...
                for (int i = 0; i < Depth; i++) sb.Append(indentString);
