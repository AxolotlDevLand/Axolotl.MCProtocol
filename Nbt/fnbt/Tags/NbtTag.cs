...
public abstract class NbtTag : ICloneable
    {
        ...
        internal static NbtTag ReadUnknownTag(NbtBinaryReader readStream)
            {
                ...
                if (newTag.ReadTag(readStream)) return newTag;
                        ...
                        switch (TagType)
                            {
                                ...
                                default:
                                    throw new InvalidCastException("Cannot get ShortValue from " +
                                                                   GetCanonicalTagName(TagType));
                            }
                    }
            }
                        ...
                        switch (TagType)
                            {
                                ...
                                default:
                                    throw new InvalidCastException("Cannot get IntValue from " +
                                                                   GetCanonicalTagName(TagType));
                            }
                    }
            }
                        ...
                        switch (TagType)
                            {
                                ...
                                default:
                                    throw new InvalidCastException("Cannot get LongValue from " +
                                                                   GetCanonicalTagName(TagType));
                            }
                    }
            }
                        ...
                        switch (TagType)
                            {
                                ...
                                default:
                                    throw new InvalidCastException("Cannot get FloatValue from " +
                                                                   GetCanonicalTagName(TagType));
                            }
                    }
            }
                        ...
                        switch (TagType)
                            {
                                ...
                                default:
                                    throw new InvalidCastException("Cannot get DoubleValue from " +
                                                                   GetCanonicalTagName(TagType));
                            }
                    }
            }
                ...
                get
                    {
                        ...
                        throw new InvalidCastException("Cannot get ByteArrayValue from " +
                                                       GetCanonicalTagName(TagType));
                    }
            }
        ...
        /// <summary>
        ///     Returns the value of this tag, cast as an long array.
                ...
                get
                    {
                        ...
                        throw new InvalidCastException("Cannot get LongArrayValue from " +
                                                       GetCanonicalTagName(TagType));
                    }
            }
                        ...
                        switch (TagType)
                            {
                                ...
                                default:
                                    throw new InvalidCastException("Cannot get StringValue from " +
                                                                   GetCanonicalTagName(TagType));
                            }
                    }
            }
